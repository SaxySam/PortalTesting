...
public class StealthCameraControllerSolution : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Time.realtimeSinceStartup >= timeNextTurn)
        {
            ...
            transform.localRotation = Quaternion.RotateTowards(transform.localRotation, Quaternion.Euler(0, nextTurnYAngle, 0), Time.deltaTime * turnSpeed);
